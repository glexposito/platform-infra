...
inputs = {
  ...
  resource_group_name            = "rg-status-page-updater-stg"
  container_app_environment_name = "cae-status-page-updater-stg"
  log_analytics_workspace_name   = "law-status-page-updater-stg"
  log_analytics_retention_in_days = 4
  container_app_name             = "ca-status-page-updater-stg"
